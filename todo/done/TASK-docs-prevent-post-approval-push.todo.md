...
| 2026-08-21 | Тимлид (Алекс) | Раздел переименован в «Подготовка PR»; из инструкции удалены пояснения (мотивация, исключение, цикл возврата из done) по замечанию владельца — документ остаётся чистой инструкцией; возврат в review. |
| 2026-08-21 | Тимлид (Алекс) | Упрощена формулировка проверки в «Перед merge» (убрана тавтология status: done и «до апрува»); возврат в review. |
| 2026-08-21 | Тимлид (Алекс) | Разграничение ответственности пакетов по замечанию владельца: механика статусов задач (поля pr/status, перенос файла, ссылки) убрана из git-workflow — осталась отсылка «по правилам проекта»; как работать со статусами описывает todo-md; возврат в review. |
