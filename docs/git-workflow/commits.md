...
- Этот документ — единый источник правил подготовки сообщений; интерактивный помощник не требуется.
...
- Срочность сама по себе не разрешает обход. Формат сообщения сохраняется при любом исключении.
